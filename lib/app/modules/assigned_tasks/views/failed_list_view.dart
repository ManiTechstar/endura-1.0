...
class FailedListView extends GetView<AssignedTasksController> {
  const FailedListView({Key? key}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Obx(() {
      List<TaskDetails> items = controller.failTaskList.value;
      return Expanded(
        child: controller.apiState.value == APIState.LOADING
            ? const LoaderView()
            : controller.failTaskList.value.isNotEmpty
                ? ListView.builder(
                    shrinkWrap: true,
