...
import 'package:fieldapp/app/modules/service_report/controllers/service_report_controller.dart';
...
class ServiceReportLeasesSearchSelectView
    extends SearchView<ServiceReportLeaseSelectorController> {
  ServiceReportLeasesSearchSelectView({Key? key}) : super(key: key);

  @override
  Widget cBuild(
      BuildContext context, ServiceReportLeaseSelectorController cController) {
...
_getLeaseFieldWidget(ServiceReportLeaseSelectorController cController) {
  return InkWell(
      onTap: () async {
